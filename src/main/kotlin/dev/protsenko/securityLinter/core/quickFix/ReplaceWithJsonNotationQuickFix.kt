...
class ReplaceWithJsonNotationQuickFix : LocalQuickFix {
    override fun getFamilyName(): @IntentionFamilyName String = SecurityPluginBundle.message("ds031.replace-with-json-notation")
    ...
    override fun applyFix(project: Project, problemDescriptor: ProblemDescriptor) {
        ...
        ApplicationManager.getApplication().runWriteAction {
            val psiCommand =
                PsiElementGenerator.fromText<DockerPsiExecOrShellCommand>(project, shellCommand) ?: return@runWriteAction
